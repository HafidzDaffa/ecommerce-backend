...
type PaymentTransaction struct {
	...
	ApplicationFeeID     *uuid.UUID     `db:"application_fee_id" json:"application_fee_id,omitempty"`
	...
	ApplicationFeeAmount float64        `db:"application_fee_amount" json:"application_fee_amount"`
	...
	ApplicationFee       *ApplicationFee `db:"-" json:"application_fee,omitempty"`
}
